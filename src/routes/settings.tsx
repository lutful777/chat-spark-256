...
function SettingsPage() {
  ...
  const isAdvancedPath = typeof window !== "undefined" && window.location.pathname.startsWith("/settings/advanced");
  if (isAdvancedPath) {
      ...
      <div className="mx-auto w-full max-w-5xl space-y-4 p-3 md:p-6">
        <section className="rounded-2xl border border-border bg-card p-4 md:p-6">
          ...
          <p className="text-xs text-muted-foreground">
            System Prompt, Temperature, Max Tokens, Enable Streaming, dan Direct Call berada di menu Advanced ini.
          </p>
        </section>
