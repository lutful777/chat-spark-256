...
import { Database, Eye, EyeOff, Loader2, Plug, Save, Search, Trash2 } from "lucide-react";
    ...
    <>
      <section className="rounded-2xl border border-border bg-card p-4 md:p-6">
        <div className="mb-3 flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold">Qdrant Memory</h2>
        </div>
        <p className="mb-4 text-xs text-muted-foreground">
          Atur endpoint dan API key Qdrant untuk memory AI besar/vector.
        </p>
        <Button asChild className="w-full gap-2 rounded-xl sm:w-auto">
          <a href="/qdrant-memory">Buka Qdrant Memory</a>
        </Button>
      </section>
