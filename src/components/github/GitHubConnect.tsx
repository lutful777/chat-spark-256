  ...
  return (
    <section className="rounded-2xl border border-border bg-card p-4 md:p-6">
      ...
      <p className="mb-4 text-xs text-muted-foreground">
        Hubungkan aplikasi ke GitHub untuk akses repository. Token disimpan hanya di browser/perangkat ini.
      </p>
      ...
      <div className="space-y-4">
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">
            Untuk akses penuh gunakan token GitHub dengan izin repository yang sesuai.
          </p>
        </div>
        ...
        <div className="grid gap-3 md:grid-cols-2">
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-muted-foreground">Klik Connect GitHub dulu agar daftar repo muncul.</p>
          </div>
